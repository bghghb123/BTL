...
public class GameUI {
    ...
    public GameUI(DropGame dropGame){
        ...
        textScore = new Label(String.format("Score: %d",score),new Label.LabelStyle(font, Color.WHITE));
        textHP = new Label(String.format("Life: %d", HP),new Label.LabelStyle(font, Color.WHITE));
