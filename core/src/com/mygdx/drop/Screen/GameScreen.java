...
import com.mygdx.drop.Entity.Drop;
...
public class GameScreen implements Screen {
    ...
    public GameScreen(final DropGame dropGame) {
        ...
        obstacleImage = new Texture("Texture/obstacle.png");
        bucketImage = new Texture("Texture/bucket.png");
        backgroundImage = new Texture("Texture/rain.jpg");
    ...
    private void spawnRaindrop() {
        Drop raindrop = new Drop(gameUI.getScore());
        Gdx.app.log( "","Score: "+ raindrop.getId());
    ...
    public void render (float dt) {
        ...
        dropGame.batch.draw(backgroundImage,0,0);
        ...
        for(Drop raindrop: raindrops) {
            if(raindrop.getId() != 0){
                ...
                dropGame.batch.draw(obstacleImage, raindrop.x, raindrop.y);
            }
        ...
        //Move Raindrop and physic logic with bucket
